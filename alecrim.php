...
<div id="TelaCaracPlanta" style = "display: none">
	<div class="corpoCaracPlanta">
		<div><h1 class="tituloDadosPlanta">Alecrim</h1></div>

		<div class="caracteristicas">
			<h3 class="tituloBox1">Características:</h3>
			<ul class="listaCaracteristicas">
				<li>- Preferencialmente em climas temperados quentes;</li>
				<li>- Necessita de bastante sol e luminosidade;</li>
				<li>- Melhor desenvolvimento em solos secos e arenosos, mas bem drenados.</li>
			</ul>
		</div>
		<div class="caracteristicas">
			<h3 class="tituloBox1">Colheita:</h3>
			<ul class="listaCaracteristicas">
				<li>- Pode começar a partir de 90 dias;</li>
				<li>- Ocorre quando apresentar altura superior a 20cm;</li>
				<li>- Cortar a parte superior da planta.</li>
			</ul>
		</div>
		<div class="caracteristicas">
			<h3 class="tituloBox1">Propriedades:</h3>
			<ul class="listaCaracteristicas">
				<li>- Rico em substâncias com propriedades anti-inflamatórias (auxilia quem sofre com artrite, gota, pressão alta);</li>
				<li>- Famoso por propriedades contra o envelhecimento, melhorando a aparência e saúde da pele;</li>
				<li>- Funciona como estimulante para todas funções cogniticas, melhorando a memória, concentração e raciocínio lógico.</li>
			</ul>
		</div>
		<div class="caracteristicas">
			<h3 class="tituloBox1">Usos Culinários:</h3>
			<ul class="listaCaracteristicas">
				<li>- Preparação de aves, carne de porco, salsichas, linguiças e batatas assadas;</li>
				<li>- Utilização em sopas e molho.</li>
			</ul>
		</div>
	</div>
